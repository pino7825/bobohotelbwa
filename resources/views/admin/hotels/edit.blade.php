            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.hotels.update', $hotel) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        value="{{ $hotel->name }}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="link_gmaps" :value="__('Link Gmaps')" />
                        <x-text-input id="link_gmaps" class="block mt-1 w-full" type="text" name="link_gmaps" 
                        value="{{ $hotel->link_gmaps }}" required autofocus autocomplete="link_gmaps" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="star_level" :value="__('Star Level')" />
                        <x-text-input id="star_level" class="block mt-1 w-full" type="number" name="star_level" value="{{ $hotel->star_level }}" required autofocus autocomplete="star_level" />
